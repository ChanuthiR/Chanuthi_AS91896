    ...
    def update(self, values):
        ...
        for i, task in enumerate(values):
            ...
            self.remove_task_button = tk.CTkButton(self, fg_color="#744B77", text="", bg_color="#744B77",height=self.task.winfo_reqheight(), width=10,
                                       image=CTkImage(light_image=Image.open("removetask_button.png"), size=(20,20)), hover_color="#744B77",
    ...
    def __init__(self):
        ...
        def update_add_button(is_hovering):
            if is_hovering:
                ...
                self.add_task_button.configure(image=CTkImage(light_image=Image.open("add_task_button.png"), size=(40, 40)))
        ...
        self.add_task_button = tk.CTkButton(self,fg_color="#160F37", text="", bg_color="#160F37",height=25, width=25,
                                       image=CTkImage(light_image=Image.open("add_task_button.png"), size=(40,40)),
